...
func TestStringToBps(t *testing.T) {
	...
	tests := []struct {
		...
		{"kbps", args{"800 kbps"}, 100000, false},
		{"mbps", args{"800 mbps"}, 100000000, false},
		{"gbps", args{"800 gbps"}, 100000000000, false},
		{"tbps", args{"800 tbps"}, 100000000000000, false},
		{"mbps simp", args{"100m"}, 12500000, false},
		{"gbps simp upper", args{"2G"}, 250000000, false},
